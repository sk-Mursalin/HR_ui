...
import { FaUsers, FaFileAlt, FaCheckCircle, FaHourglassHalf, FaTimesCircle, FaBuilding } from 'react-icons/fa'
...
const AdminSummary = () => {
    ...
    useEffect(() => {
        const fetchSummary = async () => {
            try {
                const summary = await axios.get('https://hr-server-eight.vercel.app/dashboard/summary', {
                    headers: {
    ...
    return (
        <div className='p-6'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
                ...
                {/* <SummaryCard icon={<FaMoneyBillWave />} text="Monthly Salary" number="$654" color="bg-red-300" /> */}
            </div>
            <div className="mt-12">
                <h4 className="text-center text-2xl font-bold">Leave Details</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    <SummaryCard icon={<FaFileAlt />} text="Leave Applied" number={summary.leaveSummary.appliedFor
                    } color="bg-teal-600" />
